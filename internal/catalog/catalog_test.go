  ...
  values:
    ...
    - name: media
      ...
      values:
        ...
        port: 80
        replicas: 2
        lanExpose: { enabled: true, ip: 192.0.2.50, port: 80 }
    modules:
...
func TestBuild(t *testing.T) {
	...
	if ui.LAN == nil || ui.LAN.IP != "192.0.2.50" || ui.LAN.Port != 80 {
...
func TestRenderHTML(t *testing.T) {
	...
	for _, want := range []string{
		...
		"ghcr.io/x/media-api:abc123", "autoscale 0–4", "worker", "192.0.2.50", "keda",
	} {
