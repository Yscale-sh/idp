...
// from the inline values maintained here. `jdpctl render` upserts an app
// entry; `jdpctl infra render` sets the module list. Flux installs the one
...
func platformHeader(env string) string {
	return fmt.Sprintf(
		"# Generated by jdpctl. DO NOT EDIT BY HAND.\n"+
			...
			"# Append apps with `jdpctl render`; set modules with `jdpctl infra render`.\n",
		env,
	)
}
